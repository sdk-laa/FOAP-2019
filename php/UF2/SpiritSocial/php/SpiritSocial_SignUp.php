        ...
        <div id="wrapper">
            ...
            <section>  <!-- Contenido de la pagina -->
                <div class='define'>
                    ...
                    <form action="SpiritSocial_SignUp.php/?id=<?= $_GET['id'];?>" method="POST">
                        ...
                        ?>
                        <br><br>
                        <input type="submit" name="submit" value="Sign Up">  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" name="Edit" value="Update">
                        ...
                        ?>
                                ...
                                <br><br>
                                <p><b><span class="nota"> Click in Login to start or in Table to return to the table users </span></b></p>
                                <br>
                        ...
                        <?php    
                            if ($Ucorrecto==true && $Update==true && $Errores==""){  //Si todo es correcto muetra el mensage.
                                // Si se ha creado el usuario correctamente pasarlo a base de datos
                                UpdateUser($name, $Apellido, $fecha, $email, $User);
